...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("m_child", "m_affinity", "m_base", "m_towerName", "m_cost", "m_sellCost", "m_UpgradeUI", "m_TriggerRange", "m_fireRate", "m_attack", "m_level", "m_UGParticle", "m_BuffParticle", "m_ShootParticle", "m_UGDiscount", "m_LevelDiscount", "m_AffinityDiscount", "baseModel", "Path1Model", "Path2Model", "Path3Model", "m_resource", "enabled", "name")]
