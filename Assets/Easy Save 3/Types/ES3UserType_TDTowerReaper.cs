...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path2UG2", "Path3UG2", "m_AffinityFireRate", "m_OGFireRate", "Path3UG3", "m_SoloAttack", "m_OGAttack", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer", "resourceString")]
	public class ES3UserType_TDTowerReaper : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TDTowerReaper() : base(typeof(TDTowerReaper)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (TDTowerReaper)obj;
			...
			writer.WriteProperty("m_AffinityFireRate", instance.m_AffinityFireRate, ES3Type_float.Instance);
			writer.WritePrivateField("m_OGFireRate", instance);
			writer.WriteProperty("Path3UG3", instance.Path3UG3, ES3Type_bool.Instance);
			writer.WriteProperty("m_SoloAttack", instance.m_SoloAttack, ES3Type_float.Instance);
			writer.WriteProperty("m_OGAttack", instance.m_OGAttack, ES3Type_float.Instance);
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "Path3UG2":
						...
						break;
					case "m_AffinityFireRate":
						instance.m_AffinityFireRate = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "m_OGFireRate":
					reader.SetPrivateField("m_OGFireRate", reader.Read<System.Single>(), instance);
					break;
					case "Path3UG3":
						instance.Path3UG3 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "m_SoloAttack":
						instance.m_SoloAttack = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "m_OGAttack":
						instance.m_OGAttack = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "m_Trigger":
	...
	public class ES3UserType_TDTowerReaperArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TDTowerReaperArray() : base(typeof(TDTowerReaper[]), ES3UserType_TDTowerReaper.Instance)
		{
			Instance = this;
		}
	}
