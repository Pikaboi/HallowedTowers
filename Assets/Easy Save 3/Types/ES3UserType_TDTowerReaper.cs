...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path2UG2", "Path3UG2", "m_AffinityFireRate", "m_OGFireRate", "Path3UG3", "m_SoloAttack", "m_OGAttack", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer")]
