...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer", "resourceString")]
	public class ES3UserType_TDTower_NoRangeReaper : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TDTower_NoRangeReaper() : base(typeof(TDTower_NoRangeReaper)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (TDTower_NoRangeReaper)obj;
	...
	public class ES3UserType_TDTower_NoRangeReaperArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TDTower_NoRangeReaperArray() : base(typeof(TDTower_NoRangeReaper[]), ES3UserType_TDTower_NoRangeReaper.Instance)
		{
			Instance = this;
		}
	}
