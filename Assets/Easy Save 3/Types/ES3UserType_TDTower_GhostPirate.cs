...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("m_angleSplit", "m_angleStart", "m_bulletCount", "Path3UG3", "m_PlayerBoost", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer", "resourceString")]
	public class ES3UserType_TDTower_GhostPirate : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TDTower_GhostPirate() : base(typeof(TDTower_GhostPirate)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (TDTower_GhostPirate)obj;
	...
	public class ES3UserType_TDTower_GhostPirateArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TDTower_GhostPirateArray() : base(typeof(TDTower_GhostPirate[]), ES3UserType_TDTower_GhostPirate.Instance)
		{
			Instance = this;
		}
	}
