...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("m_angleSplit", "m_angleStart", "m_bulletCount", "Path3UG3", "m_PlayerBoost", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer")]
