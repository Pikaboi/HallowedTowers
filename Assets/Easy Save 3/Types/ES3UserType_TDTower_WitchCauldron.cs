...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path1UG1", "Path1UG2", "Path1UG3", "Path2UG1", "Path2UG2", "Path2UG3", "Path3UG1", "Path3UG2", "Path3UG3", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer")]
