...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path1UG1", "Path1UG2", "Path1UG3", "Path2UG1", "Path2UG2", "Path2UG3", "Path3UG1", "Path3UG2", "Path3UG3", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer", "resourceString")]
	public class ES3UserType_TDTower_WitchCauldron : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TDTower_WitchCauldron() : base(typeof(TDTower_WitchCauldron)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (TDTower_WitchCauldron)obj;
			
			writer.WriteProperty("Path1UG1", instance.Path1UG1, ES3Type_bool.Instance);
			writer.WriteProperty("Path1UG2", instance.Path1UG2, ES3Type_bool.Instance);
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "Path1UG1":
						...
						break;
					case "Path1UG2":
						instance.Path1UG2 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "Path1UG3":
	...
	public class ES3UserType_TDTower_WitchCauldronArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TDTower_WitchCauldronArray() : base(typeof(TDTower_WitchCauldron[]), ES3UserType_TDTower_WitchCauldron.Instance)
		{
			Instance = this;
		}
	}
