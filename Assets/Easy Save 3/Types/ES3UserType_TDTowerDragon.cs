...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path1UG1", "Path1UG3", "Path2UG1", "Path2UG2", "Path2UG3", "Path3UG1", "pursuit", "m_flightPath", "m_rb", "m_speed", "m_circle", "m_fig8", "m_infinite", "m_pursuit", "notStuck", "circling", "changed", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer")]
	public class ES3UserType_TDTowerDragon : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TDTowerDragon() : base(typeof(TDTowerDragon)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (TDTowerDragon)obj;
			...
			writer.WriteProperty("Path2UG1", instance.Path2UG1, ES3Type_bool.Instance);
			writer.WriteProperty("Path2UG2", instance.Path2UG2, ES3Type_bool.Instance);
			writer.WriteProperty("Path2UG3", instance.Path2UG3, ES3Type_bool.Instance);
			writer.WriteProperty("Path3UG1", instance.Path3UG1, ES3Type_bool.Instance);
			writer.WriteProperty("pursuit", instance.pursuit, ES3Type_bool.Instance);
			...
			writer.WritePropertyByRef("m_rb", instance.m_rb);
			writer.WriteProperty("m_speed", instance.m_speed, ES3Type_float.Instance);
			writer.WritePropertyByRef("m_circle", instance.m_circle);
			writer.WritePropertyByRef("m_fig8", instance.m_fig8);
			writer.WritePropertyByRef("m_infinite", instance.m_infinite);
			writer.WritePropertyByRef("m_pursuit", instance.m_pursuit);
			writer.WriteProperty("notStuck", instance.notStuck, ES3Type_bool.Instance);
			writer.WritePrivateField("circling", instance);
			writer.WritePrivateField("changed", instance);
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "Path1UG3":
						...
						break;
					case "Path2UG1":
						instance.Path2UG1 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "Path2UG2":
						instance.Path2UG2 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "Path2UG3":
						instance.Path2UG3 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "Path3UG1":
						instance.Path3UG1 = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "pursuit":
						instance.pursuit = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "m_flightPath":
						instance.m_flightPath = reader.Read<TDTowerDragon.FlightPath>();
						break;
					case "m_rb":
						instance.m_rb = reader.Read<UnityEngine.Rigidbody>(ES3Type_Rigidbody.Instance);
						break;
					case "m_speed":
						instance.m_speed = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "m_circle":
						instance.m_circle = reader.Read<TDTower_ChangeDragon>(ES3UserType_TDTower_ChangeDragon.Instance);
						break;
					case "m_fig8":
						instance.m_fig8 = reader.Read<TDTower_ChangeDragon>(ES3UserType_TDTower_ChangeDragon.Instance);
						break;
					case "m_infinite":
						instance.m_infinite = reader.Read<TDTower_ChangeDragon>(ES3UserType_TDTower_ChangeDragon.Instance);
						break;
					case "m_pursuit":
						instance.m_pursuit = reader.Read<TDTower_ChangeDragon>(ES3UserType_TDTower_ChangeDragon.Instance);
						break;
					case "notStuck":
						instance.notStuck = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "circling":
					reader.SetPrivateField("circling", reader.Read<System.Boolean>(), instance);
					break;
					case "changed":
					reader.SetPrivateField("changed", reader.Read<System.Boolean>(), instance);
					break;
					case "m_Trigger":
	...
	public class ES3UserType_TDTowerDragonArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TDTowerDragonArray() : base(typeof(TDTowerDragon[]), ES3UserType_TDTowerDragon.Instance)
		{
			Instance = this;
		}
	}
