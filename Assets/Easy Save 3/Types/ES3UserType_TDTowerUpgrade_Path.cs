...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("m_UGPaths", "PathNum", "m_UGString", "m_UGBought", "m_successor", "m_UGCost", "m_baseCost", "m_UGName", "m_UGCostString", "m_UGPrefab", "m_resource", "m_manager", "m_sound", "m_Locked", "m_Purchased", "enabled", "name")]
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "m_UGBought":
						...
						break;
					case "m_successor":
						instance.m_successor = reader.Read<TDTowerUpgrade>();
						break;
					case "m_UGCost":
