...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("Path1UG1", "Path1UG3", "m_targets", "AimPos", "lr", "m_Trigger", "m_TriggerRange", "m_level", "m_Projectile", "m_fireRate", "m_fireRateBuff", "m_attack", "m_atkBuff", "m_aimer", "m_InRange", "m_RadiusViewer", "m_Affinity", "rotaterLookAt", "m_resource", "m_FireTimer", "resourceString")]
